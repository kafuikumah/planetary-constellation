...
function ComparisonPage() {
    ...
    if (appliedIndicator === 'all_building_blocks' || appliedIndicator === 'overall') {
        ...
        radarData = appliedCountries.length > 0 ? __TURBOPACK__imported__module__$5b$project$5d2f$Developer$2f$planetary$2d$constellation$2f$src$2f$data$2f$indicators$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildingBlocks"].map((bb)=>({
                name: bb.name,
                value: appliedCountries[0].buildingBlocks[bb.id].score
            })) : [];
        radarCompare = appliedCountries.length > 1 ? __TURBOPACK__imported__module__$5b$project$5d2f$Developer$2f$planetary$2d$constellation$2f$src$2f$data$2f$indicators$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildingBlocks"].map((bb)=>({
                name: bb.name,
                value: Math.round(appliedCountries.slice(1).reduce((sum, c)=>sum + c.buildingBlocks[bb.id].score, 0) / (appliedCountries.length - 1))
            })) : undefined;
    } else {
        ...
        if (bb) {
            ...
            // Radar makes no sense for a single point, so we just supply empty arrays
...
//# sourceMappingURL=Developer_planetary-constellation_src_0a361bea._.js.map