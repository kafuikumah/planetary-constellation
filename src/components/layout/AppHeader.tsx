...
export function AppHeader() {
    ...
    return (
        <header className="h-[60px] mx-4 mt-4 mb-2 flex items-center gap-4 flex-shrink-0 z-20">
            {/* Logo Block */}
            <div id="header-logo" className="w-[280px] h-full bg-white border border-slate-200 rounded-lg shadow-sm flex items-center px-4 gap-3 flex-shrink-0">
            ...
            {/* Navigation Block */}
            <nav id="header-nav" className="flex-1 h-full bg-white border border-slate-200 rounded-lg shadow-sm flex items-center px-10 gap-10 overflow-x-auto">
                {tabs.map((tab) => {
